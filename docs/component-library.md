...
- DM Sans for the interface, display headline and actions.
- Newsreader for business questions and editorial numerical emphasis.
- Fonts are self-hosted through pinned Fontsource packages.
